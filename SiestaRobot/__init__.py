...
def get_user_list(__init__, key):
    with open("{}/GojoRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[GojoRobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[GojoRobot]')
LOGGER.info("Gojo is starting. | An Shiinobu Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/OrochimaruBotz (t.me/saint_foire)")
